...
export default function Login() {
    return (
        <div>
            <Naviagtion />
            <section className='flex justify-center  my-9 space-x-9 container mx-auto'>
                <form action="" className='bg-gray-400 p-9 rounded-xl shadow-md shadow-white space-y-1 w-[450px] h-[450px]'>
                    ...
                    <input type="password" name='password' id='password' placeholder='......' required className='w-80 rounded-lg p-2' /> <br />
                ...
                <div className='bg-gray-400 p-9 rounded-xl shadow-md shadow-white space-y-1 w-[600px]'>
                    ...
                    <div className='py-2 border-t space-y-2 pb-5'>
                        <h1 className='py-2 text-3xl font-semibold'>
                            Find Talent
                        </h1>
